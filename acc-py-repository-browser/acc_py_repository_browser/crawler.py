...
class Crawler(base.Crawler):
    def __init__(
        ...
        self.source_context = SourceContext(internal_repository, external_repository)
...
class SourceContext:
    ...
    def __init__(self, internal_repository: SimpleRepository, external_repository: SimpleRepository):
